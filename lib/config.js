...
export const NAME = 'Decadium';
export const TAGLINE = 'Time is the strategy.';

// Public address of the site, used for absolute links in link previews. The site is served at the domain root;
// the old address coreos.live/project21 redirects here.
export const SITE_URL = 'https://decadium.club';
