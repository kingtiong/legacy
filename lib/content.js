...
export const ROADMAP = [
  ...
  ['BNB Smart Chain launch', 'Deployed 14 September 2026. Deposits of 0.01 to 10 BNB; the whole pool is capped at 100 BNB, rising 50 BNB a month, with the cap removed after three years.', 'now', 'Live'],
  ['Depositor DAO', 'Protocol fees and the choice of validators are decided by depositor votes. The team holds no role in any contract.', 'now', 'Live'],
