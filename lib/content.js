...
export const STEPS = [
  ...
  {
    title: 'Split',
    body: `${BUCKET_A_PCT}% goes into your retirement bucket, which nothing can unlock early. ${BUCKET_B_PCT}% goes into an emergency bucket you can sell if life demands it. Every deposit is split the same way.`,
  },
  {
